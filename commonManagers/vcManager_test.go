...
/*
** because GenerateBBSSelectiveDisclosure is not the same in official 0.1.5 as in future 0.1.6
*/
/*
const (
	resolveIDParts = 2
...
type keyResolverAdapter struct {
	pubKeyFetcher verifiable.PublicKeyFetcher
}

func (k *keyResolverAdapter) Resolve(id string) (*sigverifier.PublicKey, error) {
...
`
	...
	vcWithSelectiveDisclosure, err := vc.GenerateBBSSelectiveDisclosure(revealDocMap, pubKeyBytes, []byte("some nonce"),
		// verifiable.WithJSONLDDocumentLoader(getJSONLDDocumentLoader()),
